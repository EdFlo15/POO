class House:
    ...
    def __str__(self):
        return f"Stories: {self.stories}, Door type: {self.door_type}, Roof type: {self.roof_type}"
...
print("One story house:", one_story_house)
print("Two story house:", two_story_house)
